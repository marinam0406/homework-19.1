...
<main>
    ...
    <div class="container">
        <header>
            <div class="pricing-header p-3 pb-md-1 mx-auto text-center">
                <h1 class="display-6 fw-normal text-body-emphasis">Главная</h1>
                ...
                <div class="col-6">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-success w-100 btn btn-lg ">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-1">
                            <form>
                                ...
                                <button type="submit" class="btn btn-primary w-100 btn btn-lg">Отправить</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <main class="row">
            <div class="row text-center">
                <div class="col-12">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-1">
                            <h1 class="my-1 fw-normal">FAQ</h1>
                                <p class="d-inline-flex gap-1">
                                  ...
                                  <c class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample2" aria-expanded="false" aria-controls="collapseExample2">
                                    Какая гарантия?
                                  </c>
                                </p>
                                ...
                                <div class="collapse" id="collapseExample1">
                                    <div class="card card-body">
                                        content for the collapse component. This panel is hidden by default but revealed when the user activates the relevant trigger.
                                    </div>
                                </div>
                                <div class="collapse" id="collapseExample2">
                                    <div class="card card-body">
                                        for the collapse component. This panel is hidden by default but revealed when the user activates the relevant trigger.
                                    </div>
                                </div>
                        </div>
                    </div>
